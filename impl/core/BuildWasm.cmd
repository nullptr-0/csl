...
if not exist "ninja.exe" (
  rem Install Ninja
  curl -L https://github.com/ninja-build/ninja/releases/download/v1.13.2/ninja-win.zip -o ninja.zip
  tar -xzvf ninja.zip
  del ninja.zip
)
...
set "TARGET_FILES=CslLegacy.js CslWasm.js CslWasm.wasm CslWasmBundle.js %CURR_DIR%\LICENSE.txt"
